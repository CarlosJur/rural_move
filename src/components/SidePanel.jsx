...
export default function SidePanel({ open, actividades, onEdit, onDelete, onAddParticipant, onNueva }) {
  ...
  return (
    <div
      className={`flex flex-col bg-cream-50 border-r border-sage-200 transition-all duration-300 overflow-hidden flex-shrink-0 ${
        open ? 'w-72' : 'w-0'
      }`}
    >
      <div className="w-72 flex flex-col h-full">
        ...
        {/* Legend */}
        <div className="flex flex-wrap gap-x-3 gap-y-1 px-4 py-2 border-b border-sage-100 bg-cream-100">
